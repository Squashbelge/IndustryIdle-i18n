export const FR = {
    ...
    PanelPositionDesc:
        "Afficher le panneau latéral à gauche, à droite ou en automatique (dépend de la vignette actuellement sélectionnée)",
    ...
    AutoHighlight: "Surbrillance automatique",
    AutoHighlightDesc:
    ...
    IronMine2xOutputDesc:
        "Les mines de fer produisent 2 fois plus mais le transport coûte 2 fois plus de carburant",
    ...
    HelpTranslateTheGame: "Aide à la traduction du jeu🌐",
    ...
    Rome: "Rome",
    RomeBonus:
        "<li>Les Colisées sont déverrouillés</li><li>Les Colisées ont une productivité 2x</li><li>Commencez avec le centre de politique de niveau 5</li><li>Les opéras ont une capacité 2x</li><li>Enregistrement les studios produisent également de la culture</li>",
    Detroit: "Détroit",
    DetroitBonus:
    ...
    PlayerTradeQuota: "Quantité de commerce restante: %{value}",
    PlayerTradeUnavailable:
        "Vous devez avoir au moins une ressource en production et en stock avant de pouvoir échanger avec d'autres joueurs",
    PlayerTradeToClaim: "Vous avez %{num} nouvel échange(s) à réclamer dans l'échange de joueurs",
    PowerBank: "Chargeur mobile",
    PowerBankBuildDesc: "Stockez l'énergie excédentaire et fournissez l'énergie necessaire en cas de pénurie",
    PowerBankChargeSpeed: "Vitesse de charge",
    PowerBankPowerLeft: "Energie restante",
    PowerBankMoreCapacity: "Economiseur d'énergie",
    PowerBankMoreCapacityDesc: "Les Chargeurs mobiles se chargent à une vitesse de 50% mais ont 50% de capacité en plus",
    PowerBankNotWorking: "⛔ Les Chargeurs mobiles fonctionnent seulement à proximité d'une source d'énergie",
    ExcludeBuildingsShutdown: "Exclure les bâtiments qui sont à l'arrêt",
    ColorTheme: "Couleur du thème du jeu",
    ColorThemeDesc: "Couleur du thème pour les icônes, la surbrillance, la grille et l'arrière-plan. NECESSITE DE RELANCER",
    WarehouseBuildDesc: "Transportez et stockez toutes les ressources au moindre coût possible en carburant",
};
